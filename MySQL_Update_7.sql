...
('index', 'change_history', 'Historie anpassen', 'Adjust history', 'Aggiorna storia'),
('index', 'help', 'Hilfe', 'Help', 'Aiuto'),
('index', 'no_data', 'Keine Daten in den letzten %1$d Tagen gespeichert. Bitte Spindel Verbinden, damit Daten angezeigt werden können.<br /><br />Oder ändern sie die Anzahl der Tage:<br />\r\n\r\n', 'No spindle data received in the past %1$d days. Please connect Spindle to generate data.<br /><br />Or change days of history:<br />', 'Nessun dato salvato negli ultimi %1$d giorni. Collegare l\'ispindle in modo che dati recenti possano essere visualizzati.<br /> <br /> Oppure modifica il numero di giorni: <br />'),
