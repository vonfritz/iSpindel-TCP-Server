...
('BREWFATHER', 'BREWFATHER_TOKEN', 'mytoken', 'Token fr Brewfather Server', 'Token for Brewfather Server'),
...
('BREWSPY', 'BREWSPY_TOKEN', 'mytoken', 'Token fr BrewSpy Server', 'Token for BrewSpy Server'),
